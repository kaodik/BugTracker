...
export default function ProjectModal({ closeModal }: any) {
  ...
  return (
    <div className='w-[102%] h-[100%] bg-blue-200 absolute -translate-x-64 -translate-y-[3rem] flex justify-center items-center'>
      <div className='w-[500px] h-[300px] rounded-xl bg-blue-500  shadow-lg shadow-slate-900 flex flex-col p-6'>
        ...
        <div>
          <div className='pt-9 pb-3'>Project Form</div>
