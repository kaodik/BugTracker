...
export default function BugDataGrid() {
  return (
    <div className="w-full bg-gray-500 h-60 rounded-2xl ">
      <div className=" rounded-t-2xl h-2 bg-gray-200"></div>
      <div>
        <table className="item-center w-full bg-gray-200 table-">
      ...
      <div className=" rounded-b-2xl bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
